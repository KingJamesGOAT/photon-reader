        ...
        <>
            ...
            >
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3 mt-1.5">
                                        ...
                                        {isActive && (
                                            <div className="text-[10px] text-brand-500 font-medium ml-auto animate-pulse">
                                                Reading...
                                            </div>
                                        )}
                                    </div>
                ...
                <button
                    ...
                    className={clsx(
                        "hidden md:flex absolute top-1/2 -translate-y-1/2 -left-8 w-8 h-48 max-h-full rounded-l-2xl bg-white dark:bg-neutral-900 border-y border-l border-neutral-200 dark:border-neutral-800 shadow-xl text-neutral-400 hover:text-brand-500 transition-colors items-center justify-center z-50",
                        !isOpen ? "translate-x-1" : "-mr-px border-r-0"
                    )}
                >
            ...
            {!isOpen && (
                <button
                    ...
                    className="md:hidden fixed bottom-6 right-6 z-30 p-4 rounded-full bg-brand-500 text-white shadow-xl flex items-center justify-center animate-in zoom-in duration-300 active:scale-95 transition-transform"
