  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-64 w-full max-w-3xl mx-auto mb-8">
        ...
        <div className={clsx(
            ...
            <div className="flex items-baseline text-6xl md:text-7xl font-sans tracking-tight relative z-20 select-none">
                <span className="text-foreground text-right w-[11ch] overflow-visible whitespace-nowrap">
                    {leftPart}
                </span>
                <span className="text-red-600 font-bold mx-[1px] inline-block">
                    {pivotChar}
                </span>
                <span className="text-foreground text-left w-[11ch] overflow-visible whitespace-nowrap">
                    {rightPart}
                </span>
            </div>
